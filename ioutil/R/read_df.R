...
#' 
#' Reads a file in table format and creates a data frame. It is very much like read.table() function, but it is faster than read.table(), and default values are set to read a standard table with both row names and column names.
